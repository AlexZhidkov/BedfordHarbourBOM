...
insert into Parts (Type, Number, Description, IsOwnMake, Length, OwnCost, ComponentsCost)
  values (0, 'Bin', 'Bin', 0, 0, 0, 0);

-- Base
insert into Parts (Type, Number, Description, IsOwnMake, Length, OwnCost, ComponentsCost)
  values (0, 'Base', 'Base', 0, 0, 0, 0);
INSERT INTO Subassemblies (AssemblyId, SubassemblyId, InheritedCost, CostContribution)
  VALUES (1, 2, 0, 1);
insert into Parts (Type, Number, Description, IsOwnMake, Length, OwnCost, ComponentsCost)
